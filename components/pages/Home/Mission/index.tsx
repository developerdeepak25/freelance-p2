...
const missionSectionData = {
  ...
  descBullets: [
    "Raise awareness and engage the community in welfare programs.",
    "Offer support and resources to underserved groups.",
    "Collaborate with local partners for greater impact.",
    "Promote sustainable solutions for lasting community growth.",
    "Promote sustainable solutions for lasting community growth.",
  ],
